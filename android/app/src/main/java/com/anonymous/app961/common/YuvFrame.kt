...
object YuvFrame {
    ...
    private fun rotateLibYuvI420Buffer(rotationDegrees: Int) {
        ...
        when (rotationDegrees) {
            90, -270 -> changeOrientation(width, height, RotateMode.ROTATE_90)
            180, -180 -> keepOrientation(width, height, RotateMode.ROTATE_180)
            270, -90 -> changeOrientation(width, height, RotateMode.ROTATE_270)
